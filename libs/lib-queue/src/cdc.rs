#[tracing::instrument]
pub async fn create_message(message: String, db: &sqlx::PgPool) {
	let _ = sqlx::query!(
...
#[tracing::instrument]
pub async fn update_message(message: String, db: &sqlx::PgPool) {
	let _ = sqlx::query!(
        "UPDATE MESSAGES
                            SET
                            name = $1,
...
#[tracing::instrument]
pub async fn delete_message(message: String, db: &sqlx::PgPool) {
	let _ = sqlx::query!(
